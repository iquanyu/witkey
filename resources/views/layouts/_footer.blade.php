<footer class="bg-white">
	<div class="container">
		<div class="d-flex justify-content-between">
			...
			<div class="footer-list">
				...
				<ul class="list">
					...
					<li><a href="">Selling on Miver </a></li>
					<li><a href="">Buying on Miver </a></li>
				</ul>
			</div>
			<div class="footer-list">
				<h2>Community</h2>
				<ul class="list">
					...
					<li><a href="">Miver Elevate<small>Exclusive Benefits</small></a></li>
				</ul>
			</div>
			<div class="footer-list">
		...
		<div class="copyright">
			<div class="logo">
				<a href="http://v.bootstrapmb.com/2020/7/c6d6w8350/index.html"><img src="{{asset('images/logo.svg')}}"></a>
			</div>
			<p>© Copyright 2020 Miver. All Rights <a href="http://www.bootstrapmb.com/">Reserved</a></p>
			<ul class="social">
