            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    ...
                    <div class="breadcrumbs">
                        <p class="mb-0 text-white"><a class="text-white" href="">Home</a> / <span class="text-success">Product List</span></p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="filters-body">
                            <div id="accordion">
                                ...
                                <div class="filters-card p-4 border-bottom">
                                    ...
                                    Seller Details <i class="mdi mdi-chevron-down float-right"></i>
                                    </a>
                                        </h6>
                                    </div>
                                ...
                                <div class="filters-card p-4">
                                    ...
                                    Pro Services <i class="mdi mdi-chevron-down float-right"></i>
                                    </a>
                                        </h6>
                                    </div>
                    ...
                    <div class="footer-pagination text-center">
                        <nav class="mb-0 mt-0" aria-label="Page navigation example">
                            <ul class="pagination mb-0">
                                <li class="page-item"><a class="page-link" href="" aria-label="Previous"><span aria-hidden="true"><i class="fa fa-chevron-left" aria-hidden="true"></i></span><!-- <span class="sr-only"></span>--></a></li>
                                <li
                                    class="page-item"><a class="page-link" href="">1</a></li>
                                    <li class="page-item active"><a class="page-link" href="">2</a></li>
                                    <li class="page-item"><a class="page-link" href="">4</a></li>
                                    <li class="page-item"><a class="page-link" href="">5</a></li>
                                    <li class="page-item"><a class="page-link" href="" aria-label="Next"><span aria-hidden="true"><i class="fa fa-chevron-right" aria-hidden="true"></i></span><!-- <span class="sr-only"></span>--></a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
