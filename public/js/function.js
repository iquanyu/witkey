...
/* harmony import */ var _public_js_jquery_pjax_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/js/jquery.pjax.js */ "./public/js/jquery.pjax.js");
/* harmony import */ var _public_js_jquery_pjax_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_public_js_jquery_pjax_js__WEBPACK_IMPORTED_MODULE_0__);
  ...
  var Witkey = {
    init: function init() {
      ...
      $(document).on('pjax:complete', function () {
        ...
        NProgress.done(); //self._resetTitle();
      });
      self.siteBootUp();
    },
    ...
    * and pjax page load.
    */
    siteBootUp: function siteBootUp() {
      var self = this;
    }
  };
...
module.exports = __webpack_require__(/*! /www/wwwroot/witkey/resources/js/function.js */"./resources/js/function.js");
